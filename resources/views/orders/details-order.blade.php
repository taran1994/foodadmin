...
@section('content')
<!-- BEGIN: Header -->
 <?php $user = \App\Models\User::find($order->customer_id); ?>
                ...
                <div class="card-body"> 
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-control form-control-solid">{{ $user->phone }}</div>
                        </div>
                            ...
                            <table class="table table-striped align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">{{ $item->product->product_name }} ({{ $item->variant }})</td>
